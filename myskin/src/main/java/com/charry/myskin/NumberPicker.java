...
public class NumberPicker extends LinearLayout {
    private final String TAG = NumberPicker.class.getSimpleName();
     ...
     * 设置边缘透明度
     */
    private static final float FADING_EDGE_STRENGTH = 0.3f;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            if (i != mWheelMiddleItemIndex || mSelectedText.getVisibility() != VISIBLE) {
                ...
                Log.d(TAG, "scrollSelectorValue:" + scrollSelectorValue);
        ...
        if (mSelectionDivider != null) {
            if (isHorizontalMode()) {  // 水平模式
                // draw the left divider 绘制左边的竖线
                ...
                // draw the right divider 绘制右边的竖线
